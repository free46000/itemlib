...
public class ShrinkViewUtil {
    ...
    private static int getShrinkWidth(int textSize, int shrinkLen) {
    ...
    public static void setShrinkView(View view, int textSize, int shrinkWidth) {
        view.getLayoutParams().width = getShrinkWidth(textSize,shrinkWidth) + view.getPaddingLeft()
